...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.model = ImageToWordModel(model_path="Models/08_handwriting_recognition_torch/202503221811/model.onnx")
    ...
    def recognize(self):
        ...
        try:
            ...
            image_path = "Models\pruebas\img2.png"
    ...
    def prepare_image(self, image_path, scale_factor=0.6):
        """
        Convierte una imagen a formato (64, 256) para el modelo ONNX.
        - Recorta el texto automáticamente.
        - Redimensiona manteniendo proporciones con un factor de reducción.
        - Centra el texto con márgenes más grandes.
        - Normaliza los valores entre 0 y 1.

        Args:
            image_path (str): Ruta de la imagen original.
            scale_factor (float): Factor para reducir el tamaño del texto dentro del lienzo (0-1).
        """
        ...
        # Redimensionar manteniendo proporciones con factor de escala
        ...
        new_image.save("Models/pruebas/img2.png")
        print("Imagen guardada como pruebas/img2.png")

        return new_image  # Devolver imagen en formato compatible con ONNX
